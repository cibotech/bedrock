...
gulp.task('watch', function() {
    ...
    gulp.watch(workingDir + "/img/**/*.{png,jpeg,jpg,gif,svg}", ["image"]);
});
...
gulp.task("scss", function() {
    return gulp.src(workingDir + '/scss/themes/*.scss')
...
function handlebarOpts(){
    var appPath = "";
    console.log("process.env.BEDROCK_ENV_PROD : " + process.env.BEDROCK_ENV_PROD);
    if(process.env.BEDROCK_ENV_PROD == 'true'){
        appPath = "bedrock-opt.js"
    } else {
        appPath = "bedrock-fastopt.js"
    }
...
gulp.task('build', plugins.sequence(["copy", "css", "scss", "js", "scalajs", "html", "font", "image", "compile-index"]));
gulp.task('develop', plugins.sequence(["copy", "css", "scss", "js", "scalajs", "html", "font", "image", "compile-index"], "preview", "watch"));
